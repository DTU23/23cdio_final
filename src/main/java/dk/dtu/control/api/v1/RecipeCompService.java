...
public class RecipeCompService {
	...
	public void createRecipeComp(RecipeCompDTO recipeComp) throws ValidationException, DALException {
	...
	@Secured( roles = { Role.Pharmacist })
	public RecipeCompDTO getRecipeComp(@PathParam("recipeId") int recipeId, @PathParam("produceId") int produceId) throws ValidationException, DALException {
	...
	@PUT
	@Secured( roles = { Role.Pharmacist })
	public void updateRecipeComp(RecipeCompDTO recipeComp) throws ValidationException, DALException {
	...
	@Path("/{recipeId}/{produceId}")
	@Secured( roles = { Role.Pharmacist })
	public void deleteProduce(@PathParam("recipeId") int recipeId, @PathParam("produceId") int produceId) throws ValidationException, DALException {
		Validation.isPositiveInteger(recipeId);
		Validation.isPositiveInteger(produceId);
